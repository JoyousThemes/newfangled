...
Newfangled is best suited for all types of site and uses Theme Customizer.

Newfangled WordPress Theme, Copyright (C) 2017, Joyousthemes
Newfangled is distributed under the terms of the GNU GPL

== Description ==  
Newfangled is a free WordPress theme to use for multipurpose. It fits for business,commercial Uses and other purposes. You can use multiple sliders and Icon with services, BreadCrumb with related featured image of Post and Page. It has a Clean look of Blog view and widgetized footer. Newfangled is a responsive, Translation Ready and Customizable Options. If you have any queries ping to this maild ID: joyousthemes@gmail.com

== Frequently Asked Questions == 
= Installation =
1. Download and unzip `newfangled` theme
2. Upload the `newfangled` folder to the `/wp-content/themes/` directory
...
10. Select the image content section.
...
* Screenshot Images is licensed under CC0 Public Domain License.
	* image © 2015 Pixabay, CC0 1.0 ,https://pixabay.com/en/rice-sow-adult-ancient-asia-1807554/
	* image © 2015 Pixabay, CC0 1.0 ,https://pixabay.com/en/plant-branch-young-leaves-spring-713582/
